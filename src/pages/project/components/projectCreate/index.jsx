...
import { Button, Card, List, Typography, message, notification, Modal, Form, Input, InputNumber, Radio, Divider, Tooltip } from 'antd';
...
class ProjectCreateModal extends React.Component {
    ...
    render() {
        const { vcsType, vcsUrl, vcsUserName, vcsPassWord } = this.state.formData;
        const currentVcsUrl = `${vcsType}|${vcsUrl}|${vcsUserName}|${vcsPassWord}`;
